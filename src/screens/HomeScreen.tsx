    ...
    <>
      ...
      <main className="flex-1 overflow-y-auto pt-1 pb-24 flex flex-col gap-layout-gap scrollbar-hide">
        ...
        <div className="flex flex-col gap-inner-gap mt-1">
          ...
          {['Science', 'Static GK', 'History', 'Geography'].map((subject) => (
            <div 
              key={subject} 
            ...
            >
              <div className="flex flex-col">
                <span className="text-base font-bold text-text-primary">{subject}</span>
                <span className="text-xs text-text-muted font-semibold mt-1">4 Weak Chapters</span>
              </div>
